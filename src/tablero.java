...
public class tablero extends JPanel {
	...
	private Image img1 = Toolkit.getDefaultToolkit().getImage("./wall.png");
	private Image img2 = Toolkit.getDefaultToolkit().getImage("./robot.png");
	private Image img3 = Toolkit.getDefaultToolkit().getImage("./fin.png");
